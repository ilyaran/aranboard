...
$config['DX_website_name'] = 'KRISTY.KZ';
$config['DX_webmaster_email'] = 'ilyaran@mail.ru';
...
$config['DX_email_activation'] = TRUE; //TRUE; 
$config['DX_email_activation_expire'] = 1728000; //1728000;// 60*60*24*20; 
$config['DX_email_account_details'] = TRUE; //TRUE; 
...
$config['DX_max_login_attempts'] = 12; 
