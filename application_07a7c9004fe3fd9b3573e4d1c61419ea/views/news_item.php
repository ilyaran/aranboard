...
<div class="col-md-24 col-lg-24 col-sm-24 col-xs-24">
   <h5>
      <ol class="breadcrumb">
         <li><a href="<?php echo site_url('home/news')?>"><?php echo $this->lang->line('News'); ?></a></li>
         <?php 
            ...
            { 
               ...
               {
                  echo '<li><a href="'.site_url('home/news/'.$i['category_id']).'">'.$i['name'].'</a></li>';
               }
            }   
            if( !empty(CI_Controller::$breadcrumb['current']))
            {
               echo '<li class="active"><a href="'.site_url('home/news/'.CI_Controller::$breadcrumb['current']['category_id']).'">'.CI_Controller::$breadcrumb['current']['name'].'</a></li>';
            }
      ...
      <div class="panel panel-default">
         ...
         <div class="panel-body">
            ...
            <div style="word-break: break-all;margin: 5px;">
               ...
               <?php echo CI_Controller::$data['news']['updated'].' : '.CI_Controller::$data['news']['author']; ?>
            </div>
            <hr />
