   ...
   <div class="col-md-24">      
      <div class="panel panel-default">
         <div class="panel-heading">
            <?php echo $this->lang->line('Edit page').'&nbsp;<span class="error">*</span>&nbsp;'.$this->lang->line('Required fields');?>
         </div>
               ...
               <form name="add_form" id="add_form"  action="" onsubmit="return presubmit()" method="post" enctype="multipart/form-data">
                  <table class="table table-striped table-bordered table-hover">
                     ...
                     <tr>
                        ...
                        <td>
                           <input style="width: 100%;" onchange="check(this);" type="text" name="url" id="url" value="<?php echo set_value('url',CI_Controller::$data['page']['url']); ?>" />
                        </td>
                     </tr>
                     <tr>
                        <td style="width: 20%;">
                        ...
                        <td>
                           <input style="width: 20%;" type="number" name="sort" id="sort" value="<?php echo set_value('sort',CI_Controller::$data['page']['sort']); ?>" />
                        </td>
                     ...
                     <tr>
                        ...
                        <td>
                           &nbsp;&nbsp;<?php echo $this->lang->line('Display');?> &nbsp;<input type="checkbox" <?php echo set_value('display',CI_Controller::$data['page']['display']) == 1 ? 'checked=""':''; ?> value="1" name="display" />
                        </td>
                     </tr>
                     <tr>
                        <td style="width: 20%;">
                        ...
                        <td>
                           <input style="width: 100%;" onchange="check(this);" type="text" name="title" id="title" value="<?php echo set_value('title',CI_Controller::$data['page']['title']); ?>" />
                        </td>
                     </tr>
                     <tr>
                        <td>
                        ...
                        <td><textarea onchange="check(this);" name="body" id="body" style="width: 100%;height: 150px;" ><?php echo set_value('body',CI_Controller::$data['page']['body']); ?></textarea></td>
                     </tr>
