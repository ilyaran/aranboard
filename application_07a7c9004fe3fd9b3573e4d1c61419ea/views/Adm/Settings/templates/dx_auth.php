...
$config['DX_website_name'] = '<?php echo set_value('DX_website_name');?>';
$config['DX_webmaster_email'] = '<?php echo set_value('DX_webmaster_email');?>';
...
$config['DX_salt'] = '<?php echo set_value('DX_salt');?>';
...
$config['DX_email_activation'] = <?php echo set_value('DX_email_activation')==1 ? 'TRUE' : 'FALSE';?>; //TRUE; 
$config['DX_email_activation_expire'] = <?php echo set_value('DX_email_activation_expire');?>; //1728000;// 60*60*24*20; 
$config['DX_email_account_details'] = <?php echo set_value('DX_email_account_details')==1 ? 'TRUE' : 'FALSE';?>; //TRUE; 
...
$config['DX_autologin_cookie_life'] = 5184000; //60*60*24*31*2;
/*
|--------------------------------------------------------------------------
| Login attempts
|--------------------------------------------------------------------------
...
$config['DX_max_login_attempts'] = <?php echo set_value('DX_max_login_attempts');?>; 
...
$config['DX_forgot_password_expire'] = 9000;
