   ...
   <!-- Right_bar -->
      ...
      <?php echo '<?php $this->load->view(\'Widgets/category/menu_vertical_news\'); ?>'; ?>          
      </div>
   <!-- /Right_bar --></div>
</div>
...
<script type="text/javascript" src="<?php echo base_url($this->config->item('theme_public').'js/jquery-2.1.0.min.js'); ?>"></script>
<script type="text/javascript" src="<?php echo base_url($this->config->item('theme_public').'js/bootstrap.min.js'); ?>"></script>
