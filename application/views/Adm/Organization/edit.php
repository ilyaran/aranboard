   ...
   <div class="col-md-24">      
      ...
      <div class="panel panel-default">
         <div class="panel-heading">
            <?php echo $this->lang->line('Edit advert').'&nbsp;<span class="error">*</span>&nbsp;'.$this->lang->line('Required fields');?>
         </div>
               ...
               <form name="add_form" id="add_form"  action="" onsubmit="return presubmit()" method="post" enctype="multipart/form-data">
                  <table class="table table-striped table-bordered table-hover">
                     ...
                     <tr>
                        ...
                        <?php $this->load->view('Widgets/category/options'); ?>
                        </select>
                        </td>
                     ...
                     <tr>
                        ...
                        <td>
                           &nbsp;&nbsp;<?php echo $this->lang->line('Enabled');?> &nbsp;<input type="checkbox" <?php echo set_value('enabled',CI_Controller::$data['advert']['enabled'])==1 ? 'checked=""':''; ?> value="1" name="enabled" />
                           
                        </td>
                        <script>
                        document.getElementById("category_id").value = <?php echo set_value('category_id',CI_Controller::$data['advert']['category_id']); ?>;
                        </script>
                     </tr>
                     <tr>
                        <td style="width: 20%;">
                        ...
                        <td><input style="width: 100%;" onchange="check(this);" type="text" name="title" id="title" value="<?php echo set_value('title',CI_Controller::$data['advert']['title']); ?>" /></td>
                     </tr>
                     <tr>
                        <td>
                        ...
                        <td><textarea onchange="check(this);" name="text" id="text" style="width: 100%;height: 150px;" ><?php echo set_value('text',CI_Controller::$data['advert']['text']); ?></textarea></td>
                     </tr>
                     <tr>
                        <td>
                        ...
                        <td><input style="width:50%;" name="price" onchange="check(this);" type="number" value="<?php echo set_value('price',CI_Controller::$data['advert']['price']); ?>" /></td>
                     </tr>
                        <tr>
                           <td>
                           ...
                           <td><textarea name="contacts" onchange="check(this);" style="width: 100%;height: 100px;"><?php echo set_value('contacts',CI_Controller::$data['advert']['contacts']); ?></textarea></td>
                        </tr>
                        <tr>
                           <td>
                           ...
                           <td>
                              <table style="width: 100%;">
                                 ...
                                 <tr>
                                    ...
                                    <?php 
                                    if(is_array(CI_Controller::$data['advert']['img']))
                                    {
                                       foreach(CI_Controller::$data['advert']['img'] as $a=>$i) 
                                       { ?>
