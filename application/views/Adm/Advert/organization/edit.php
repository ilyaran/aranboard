   ...
   <div class="col-md-24">      
      ...
      <div class="panel panel-default">
         <div class="panel-heading">
            <?php echo $this->lang->line('Edit organization').'&nbsp;<span class="error">*</span>&nbsp;'.$this->lang->line('Required fields');?>
         </div>
               ...
               <form name="add_form" id="add_form"  action="" onsubmit="return presubmit()" method="post" enctype="multipart/form-data">
                  <table class="table table-striped table-bordered table-hover">
                     ...
                     <tr>
                        ...
                        <?php $this->lib_tree->options('organization'); ?>
                        </select>
                        <script type="text/javascript">
                     
                        document.getElementById("category_id").value = "<?php echo set_value('category_id',CI_Controller::$data['organization']['category_id']); ?>";
                     ...
                     <tr>
                        ...
                        <td>
                           &nbsp;&nbsp;<?php echo $this->lang->line('Enabled');?> &nbsp;<input type="checkbox" <?php echo set_value('enabled',CI_Controller::$data['organization']['enabled'])==1 ? 'checked=""':''; ?> value="1" name="enabled" />
                     ...
                     <tr>
                        ...
                        <td><input style="width: 100%;" onchange="check(this);" type="text" name="title" id="title" value="<?php echo set_value('title',CI_Controller::$data['organization']['title']); ?>" /></td>
                     </tr>
                     <tr>
                        <td>
                        ...
                        <td><textarea onchange="check(this);" name="text" id="text" style="width: 100%;height: 150px;" ><?php echo set_value('text',CI_Controller::$data['organization']['text']); ?></textarea></td>
                     </tr>
                        ...
                        <tr>
                           ...
                           <td><textarea name="contacts" onchange="check(this);" style="width: 100%;height: 100px;"><?php echo set_value('contacts',CI_Controller::$data['organization']['contacts']); ?></textarea></td>
                        </tr>
                        <tr>
                           <td>
