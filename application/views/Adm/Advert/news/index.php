<div class="row">
   ...
   <h5>
      <ol class="breadcrumb">
         <li><a href="<?php echo site_url('adm/advert/index/news')?>"><?php echo $this->lang->line("News");?></a></li>
         <?php 
            ...
            { 
               ...
               {
                  echo '<li><a href="'.site_url('adm/advert/index/news/'.$i['category_id']).'">'.$i['name'].'</a></li>';
               }
            }   
            if( !empty(CI_Controller::$breadcrumb['current']))
            {
               echo '<li class="active"><a href="'.site_url('adm/advert/index/news/'.CI_Controller::$breadcrumb['current']['category_id']).'">'.CI_Controller::$breadcrumb['current']['name'].'</a></li>';
            }
...
<div class="row">
   <div class="col-md-24 col-lg-24 col-sm-24 col-xs-24">
      ...
      <div class="panel panel-default">
         <div class="panel-heading"><?php echo $this->lang->line("News");?>
         &nbsp;&nbsp;<a class="btn btn-info" href="<?php echo site_url("adm/advert/add/news"); ?>"><?php echo $this->lang->line("Add news"); ?></a>
         <input type="submit" form = "in_list" style="float: right;" />
         </div>
         <div id="cabinet_panel" class="panel-body">
             <?php if(isset(CI_Controller::$data['news'][0])) { ?>
             <div class="table-responsive">
                 <form action="<?php echo site_url("adm/advert/in_list/news");?>" method="post" id="in_list" name="in_list">
                 <table class="table table-striped table-bordered table-hover">
                     ...
                     <tbody>
                     <?php foreach(CI_Controller::$data['news'] as $i) { ?>
                         <tr>
                             <td><img src="upload/img/<?php echo $i['logo'] == null ? 'noimg.jpg' : $i['logo']; ?>" width="50" height="50"></td>
                             <td><a href="<?php echo site_url("home/news_item/{$i['news_id']}"); ?>"><?php echo $i['title']; ?></a></td>
                             <td>
                                 <input type="hidden" value="-1" name="status[<?php echo $i['news_id']; ?>]" />
                             ...
                             <td>
                              ...
                              <a href="<?php echo site_url("adm/advert/edit/{$i['news_id']}/news"); ?>"><i class="fa fa-edit fa-fw"></i></a>
                              <a href="<?php echo site_url("adm/advert/del/news/{$i['news_id']}"); ?>"><i class="fa fa-times"></i></a>
                              <input class="del_item" name="del[]" value="<?php echo $i['news_id']; ?>" title="<?php echo $this->lang->line('Check for delete this item');?>" type="checkbox" value="1" />
            ...
            <?php }else{ ?>
            <h3><?php echo $this->lang->line("No news");?></h3>
            <?php } ?>  
         </div>
     </div>
