...
<div class="auth">
<fieldset><legend><?php echo $this->lang->line('Register'); ?></legend>
...
<dl>
	...
	<dt><?php echo form_label($this->lang->line('Confirm Password'), $confirm_password['id']);?></dt>
	<dd>
		<?php echo form_password($confirm_password);?>
		<?php echo form_error($confirm_password['name']); ?>
	</dd>

	<dt><?php echo form_label($this->lang->line('Email Address'), $email['id']);?></dt>
	<dd>
...
<?php endif; ?>
	...
	<dt></dt>
	<dd><?php echo form_submit('register',$this->lang->line('Register'));?></dd>
</dl>
